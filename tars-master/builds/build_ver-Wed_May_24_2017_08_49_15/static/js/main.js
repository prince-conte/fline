...
$(function(){
  ...
  $('.js-map-content-close').on('click', function () {
      $('.js-map-content').css('display','none');
      return false;
  });
});
$(function(){
